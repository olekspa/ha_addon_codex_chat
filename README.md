...
1. Update `codex_chat/config.yaml` `version` (example: `0.3.8`).
...
4. GitHub Action `.github/workflows/build-addon-images.yml` builds and pushes:
   - `ghcr.io/<owner>/amd64-codex_chat:0.3.8`
   - `ghcr.io/<owner>/aarch64-codex_chat:0.3.8`
   - `ghcr.io/<owner>/armv7-codex_chat:0.3.8`
